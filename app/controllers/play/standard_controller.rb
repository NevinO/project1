# The StandardController class handles all requests from the user
# while they are playing the tic tac toe game
#
# === Remarks
# some good links for drag and drop with rails
# 1. http://www.ruby-forum.com/topic/46056#new
#
# The following methods/actions are exposed as ajax method
# 1. receive_move_by_player
# 2. receive_move_by_application
#
# :title Play::StandardController
