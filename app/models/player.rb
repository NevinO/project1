# This class represents each player in the game of tic tac toe
# both the X player and the O player
# relations
# 1. has many games
# 
# contains helper methods to get the count of game outcomes for the individual player
# 1. total games played
# 2. total games won
# 3. total games lost
# 4. total games equalized
#
# :title Player
